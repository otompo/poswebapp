...
function ServicesAccordion(props) {
  return (
    <div className="container my-5" id="accordion">
      <div className="row">
          ...
          <div className="accordion" id="accordionExample">
            <div className="accordion-item">
              <h2 className="accordion-header" id="headingOne">
                ...
                >
                  <h4>Wedding Video Production</h4>
                </button>
              </h2>
              <div
                id="collapseOne"
            ...
            <div className="accordion-item">
              <h2 className="accordion-header" id="headingTwo">
                ...
                >
                  <h4>Commercial & Private Video Advertising</h4>
                </button>
              </h2>
              <div
                id="collapseTwo"
            ...
            <div className="accordion-item">
              <h2 className="accordion-header" id="headingFoure">
                ...
                >
                  <h4>Parties Videos Production</h4>
                </button>
              </h2>
              <div
                id="collapseFoure"
            ...
            <div className="accordion-item">
              <h2 className="accordion-header" id="headingFive">
                ...
                >
                  <h4>Family videos Production</h4>
                </button>
              </h2>
              <div
                id="collapseFive"
            ...
            <div className="accordion-item">
              <h2 className="accordion-header" id="headingSix">
                ...
                >
                  <h4>Business Events videos Production</h4>
                </button>
              </h2>
              <div
                id="collapseSix"
